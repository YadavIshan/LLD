...
public class UserManager {
    ...
    //Currently UserManager class was focused on one Responsibility which was managing user
    //But now we need to add new functionality to log user activity , which breaks the single responsibility principle
